...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  ...
  },
  {
    id: "memory_ask",
    label: "memory_ask",
    description: "Ask memories a question",
    sectionId: "memory",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  ...
  {
    id: "memory_add_batch",
    label: "memory_add_batch",
    description: "Batch store memories",
    sectionId: "memory",
    profiles: ["coding"],
  },
  {
  ...
  {
    id: "memory_delete_batch",
    label: "memory_delete_batch",
  ...
  {
    id: "memory_categories",
    label: "memory_categories",
  ...
  {
    id: "memory_save_artifact",
    label: "memory_save_artifact",
    description: "Attach artifact to memory",
    sectionId: "memory",
    profiles: ["coding"],
  },
  {
    id: "memory_get_artifact",
    label: "memory_get_artifact",
    description: "Retrieve artifact content",
    sectionId: "memory",
    profiles: ["coding"],
  },
  {
    id: "memory_list_artifacts",
    label: "memory_list_artifacts",
  ...
  },
  {
    ...
    label: "memory_delete_artifact",
    description: "Delete a memory artifact",
    sectionId: "memory",
    profiles: ["coding"],
  },
  {
